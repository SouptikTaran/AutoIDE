      ...
      if (response.ok) {
        ...
        if (data.error) {
          setMessages((prev) => [
            ...
            {
              role: "assistant",
              content: `Error: ${data.error}. Please check your OpenRouter configuration.`,
              timestamp: new Date(),
              id: Date.now().toString(),
            },
          ]);
        ...
        setMessages((prev) => [
          ...
          {
            role: "assistant",
            content: `Sorry, I encountered an error: ${errorMessage}. Please check your OpenRouter API configuration and try again.`,
            timestamp: new Date(),
            id: Date.now().toString(),
          },
        ]);
